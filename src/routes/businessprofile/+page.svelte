<script>
	...
	onMount(async () => {
  // Check if the user is authenticated (you may need to adjust this condition)
  isAuthenticated = true; // Set this to true if the user is authenticated, otherwise set it to false
...
<main class="container">
	...
	<h1 style="margin-top: 0px; margin-left:180px ;color:darkgreen;  font-size:30px ; font:bold">Business Profile</h1>
